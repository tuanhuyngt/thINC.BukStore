...
namespace thINC.BukStore.Test.Base.DependencyInjection
{
    public static class ServiceCollectionRegistrar
    {
        public static void Register(IIocManager iocManager)
        {
            ...
            iocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<BukStoreDbContext>>()
            ...
            new BukStoreDbContext(builder.Options).Database.EnsureCreated();
        }
