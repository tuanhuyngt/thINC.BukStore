...
using thINC.BukStore.MultiTenancy.HostDashboard;
...
namespace thINC.BukStore.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(BukStoreDbContext context, SubscriptionPayment subscriptionPayment)
        {
