...
using thINC.BukStore.Auditing.Exporting;
...
using EntityHistoryHelper = thINC.BukStore.EntityHistory.EntityHistoryHelper;

namespace thINC.BukStore.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : BukStoreAppServiceBase, IAuditLogAppService
    {
