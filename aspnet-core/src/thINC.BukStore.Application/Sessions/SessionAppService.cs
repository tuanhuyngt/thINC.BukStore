...
{
    public class SessionAppService : BukStoreAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = BukStoreConsts.Currency,
                    CurrencySign = BukStoreConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = BukStoreConsts.AllowTenantsToChangeEmailSettings,
