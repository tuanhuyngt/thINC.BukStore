...
using thINC.BukStore.EntityFrameworkCore.Repositories;

namespace thINC.BukStore.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : BukStoreRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<BukStoreDbContext> dbContextProvider)
