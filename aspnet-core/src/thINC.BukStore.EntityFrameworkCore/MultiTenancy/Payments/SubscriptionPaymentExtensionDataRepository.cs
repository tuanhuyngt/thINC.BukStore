...
{
    public class SubscriptionPaymentExtensionDataRepository : BukStoreRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<BukStoreDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
