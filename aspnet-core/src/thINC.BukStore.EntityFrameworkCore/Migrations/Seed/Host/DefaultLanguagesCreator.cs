...
namespace thINC.BukStore.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = BukStoreConsts.MultiTenancyEnabled ? null : (int?)1;
        ...
        public DefaultLanguagesCreator(BukStoreDbContext context)
        {
            _context = context;
        }
