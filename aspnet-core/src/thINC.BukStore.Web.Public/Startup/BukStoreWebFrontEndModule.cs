...
namespace thINC.BukStore.Web.Public.Startup
{
    [DependsOn(
        typeof(BukStoreWebCoreModule)
    )]
    public class BukStoreWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public BukStoreWebFrontEndModule(IWebHostEnvironment env, BukStoreEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(BukStoreWebFrontEndModule).GetAssembly());
        }
    }
}
