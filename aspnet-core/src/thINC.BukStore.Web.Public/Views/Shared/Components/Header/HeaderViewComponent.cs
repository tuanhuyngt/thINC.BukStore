...
using thINC.BukStore.Web.Public.Startup;
using thINC.BukStore.Web.Session;

namespace thINC.BukStore.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : BukStoreViewComponent
    {
