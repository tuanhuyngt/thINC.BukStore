...
namespace thINC.BukStore.Web.Startup
{
    ...
    public class BukStoreWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public BukStoreWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(BukStoreWebHostModule).GetAssembly());
        }
