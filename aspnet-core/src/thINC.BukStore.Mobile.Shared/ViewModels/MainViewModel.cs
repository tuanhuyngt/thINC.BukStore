...
using MvvmHelpers;
using thINC.BukStore.Authorization.Users.Profile;
using thINC.BukStore.Authorization.Users.Profile.Dto;
using thINC.BukStore.Commands;
...
using thINC.BukStore.Controls;
using thINC.BukStore.Dto;
using thINC.BukStore.Extensions;
using thINC.BukStore.Localization;
using thINC.BukStore.UI;
using thINC.BukStore.UI.Assets;
using thINC.BukStore.Views;
using DependencyResolver = thINC.BukStore.Core.Dependency.DependencyResolver;
...
namespace thINC.BukStore.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "BukStore";
