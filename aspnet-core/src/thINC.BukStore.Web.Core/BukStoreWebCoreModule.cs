...
using thINC.BukStore.Web.Authentication.JwtBearer;
using thINC.BukStore.Web.Authentication.TwoFactor;
using thINC.BukStore.Web.Chat.SignalR;
using thINC.BukStore.Web.Configuration;
using thINC.BukStore.Web.DashboardCustomization;

namespace thINC.BukStore.Web
{
    [DependsOn(
    ...
    public class BukStoreWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public BukStoreWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(BukStoreApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(BukStoreWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(BukStoreWebCoreModule).Assembly);
        }
