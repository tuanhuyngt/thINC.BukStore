...
namespace thINC.BukStore.Web.Authentication.JwtBearer
{
    public class BukStoreJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public BukStoreJwtSecurityTokenHandler()
        {
