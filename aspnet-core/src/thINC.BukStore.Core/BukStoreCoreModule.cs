...
using thINC.BukStore.Authorization.Ldap;
...
using thINC.BukStore.DashboardCustomization.Definitions;
using thINC.BukStore.Debugging;
using thINC.BukStore.DynamicEntityParameters;
using thINC.BukStore.Features;
using thINC.BukStore.Friendships;
using thINC.BukStore.Friendships.Cache;
using thINC.BukStore.Localization;
using thINC.BukStore.MultiTenancy;
using thINC.BukStore.Net.Emailing;
using thINC.BukStore.Notifications;
using thINC.BukStore.WebHooks;

namespace thINC.BukStore
{
    [DependsOn(
        typeof(BukStoreCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class BukStoreCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            BukStoreLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = BukStoreConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, BukStoreMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<BukStoreSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(BukStoreCoreModule).GetAssembly());
        }
