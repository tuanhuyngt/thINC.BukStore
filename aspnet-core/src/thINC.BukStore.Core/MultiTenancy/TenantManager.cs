...
using thINC.BukStore.MultiTenancy.Demo;
...
namespace thINC.BukStore.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(BukStoreConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(BukStoreConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
