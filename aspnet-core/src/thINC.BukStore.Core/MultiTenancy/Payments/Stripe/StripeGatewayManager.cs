...
{
    public class StripeGatewayManager : BukStoreServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "BukStore";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + BukStoreConsts.Currency;
        }
