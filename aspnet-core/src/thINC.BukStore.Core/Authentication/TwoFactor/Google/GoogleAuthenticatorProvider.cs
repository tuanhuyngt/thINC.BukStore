...
namespace thINC.BukStore.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : BukStoreServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("thINC.BukStore", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
