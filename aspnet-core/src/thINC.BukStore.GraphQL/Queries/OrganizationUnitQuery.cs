...
using thINC.BukStore.Core.Base;
using thINC.BukStore.Core.Extensions;
using thINC.BukStore.Dto;
using thINC.BukStore.Types;

namespace thINC.BukStore.Queries
{
    public class OrganizationUnitQuery : BukStoreQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
