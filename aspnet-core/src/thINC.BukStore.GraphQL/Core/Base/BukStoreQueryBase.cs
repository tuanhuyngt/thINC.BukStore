...
namespace thINC.BukStore.Core.Base
{
    public abstract class BukStoreQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected BukStoreQueryBase(string fieldName,
