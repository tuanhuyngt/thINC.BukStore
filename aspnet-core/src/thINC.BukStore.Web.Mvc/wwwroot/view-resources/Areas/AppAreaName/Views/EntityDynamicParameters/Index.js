(function () {
    $(function () {
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppAreaName/EntityDynamicParameter/CreateModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/EntityDynamicParameters/_CreateModal.js',
        ...
        _table.find('tbody').on('click', 'tr', function () {
            ...
            if (data) {
                window.location = "/AppAreaName/EntityDynamicParameter/Detail/" + data.entityFullName;
            }
        });
