(function () {
    $(function () {
        ...
        var _permissions = {
            ...
            dynamicParameterEdit: abp.auth.hasPermission('Pages.Administration.EntityDynamicParameterValue.Edit')
        };
        ...
        var _dynamicParametersModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppAreaName/EntityDynamicParameterValue/ManageEntityDynamicParameterValuesModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/_Bundles/manage-entity-dynamic-parameter-values-modal-min.js',
                ...
                },
                {
                    ...
                    rowAction: {
                        ...
                        items: [{
                            ...
                            text: app.localize('DynamicParameters'),
                            visible: function () {
                                return _permissions.dynamicParameterEdit;
                            },
                            action: function (data) {
                                _dynamicParametersModal.open({ entityFullName: 'thINC.BukStore.Authorization.Users.User', rowId: data.record.id});
                            }
                        }, {
