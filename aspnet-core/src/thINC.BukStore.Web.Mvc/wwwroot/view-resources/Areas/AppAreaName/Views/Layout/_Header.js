(function ($) {
    $(function () {
        ...
        var userDelegationsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppAreaName/Profile/UserDelegationsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/Profile/_UserDelegationsModal.js',
