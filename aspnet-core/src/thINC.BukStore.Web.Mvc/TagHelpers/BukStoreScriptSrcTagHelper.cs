...
namespace thINC.BukStore.Web.TagHelpers
{
    [HtmlTargetElement("script", Attributes = AbpSrcAttributeName)]
    public class BukStoreScriptSrcTagHelper : TagHelper
    {
        ...
        public BukStoreScriptSrcTagHelper(IWebHostEnvironment hostingEnvironment, IHttpContextAccessor httpContextAccessor)
        {
