...
namespace thINC.BukStore.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTheme8Footer
{
    public class AppAreaNameTheme8FooterViewComponent : BukStoreViewComponent
    {
