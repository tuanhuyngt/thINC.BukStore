...
namespace thINC.BukStore.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTheme4Brand
{
    public class AppAreaNameTheme4BrandViewComponent : BukStoreViewComponent
    {
