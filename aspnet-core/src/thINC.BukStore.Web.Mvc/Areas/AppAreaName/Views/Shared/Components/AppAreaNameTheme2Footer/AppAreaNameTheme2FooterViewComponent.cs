...
namespace thINC.BukStore.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTheme2Footer
{
    public class AppAreaNameTheme2FooterViewComponent : BukStoreViewComponent
    {
