...
namespace thINC.BukStore.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTheme3Footer
{
    public class AppAreaNameTheme3FooterViewComponent : BukStoreViewComponent
    {
