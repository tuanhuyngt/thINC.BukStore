...
using thINC.BukStore.Configuration.Host;
using thINC.BukStore.Editions;
using thINC.BukStore.Timing;
using thINC.BukStore.Timing.Dto;
using thINC.BukStore.Web.Areas.AppAreaName.Models.HostSettings;
...
namespace thINC.BukStore.Web.Areas.AppAreaName.Controllers
{
    ...
    public class HostSettingsController : BukStoreControllerBase
    {
