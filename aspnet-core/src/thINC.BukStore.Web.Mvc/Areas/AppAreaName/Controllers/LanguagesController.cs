...
using thINC.BukStore.Web.Areas.AppAreaName.Models.Languages;
...
namespace thINC.BukStore.Web.Areas.AppAreaName.Controllers
{
    ...
    public class LanguagesController : BukStoreControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = BukStoreConsts.LocalizationSourceName;
            }
