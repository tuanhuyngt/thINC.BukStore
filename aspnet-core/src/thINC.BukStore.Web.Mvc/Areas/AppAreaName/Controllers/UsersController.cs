...
using thINC.BukStore.Authorization.Permissions;
...
using thINC.BukStore.Web.Areas.AppAreaName.Models.Roles;
using thINC.BukStore.Web.Areas.AppAreaName.Models.Users;
...
namespace thINC.BukStore.Web.Areas.AppAreaName.Controllers
{
    ...
    public class UsersController : BukStoreControllerBase
    {
